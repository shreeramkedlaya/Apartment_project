...
export type IssueStatus = 'Open' | 'Acknowledged' | 'Assigned' | 'In Progress' | 'Resolved' | 'Closed';

const STAGES: IssueStatus[] = ['Open', 'Acknowledged', 'Assigned', 'In Progress', 'Resolved', 'Closed'];
